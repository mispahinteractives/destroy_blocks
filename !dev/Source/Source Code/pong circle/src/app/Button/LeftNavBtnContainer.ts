...
export class LeftNavBtnContainer extends Container{
    ...
    constructor(){
        ...
        Game.the.app.stage.on(CommonConfig.TUTORIAL_LEFT_CLICK, this.leftClick, this);
    }
    ...
    private onButtonDown() :void{
        ...
        CommonConfig.the.setCurrentBtn("ArrowLeft");
        this.buttton.scale.set(-0.40,0.40);
    }
